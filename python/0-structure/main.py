...
from src.ExampleClass import example_function                         # example_function aus ExampleClass.py importieren
...
function_result: int = example_function(3, 4)                         # Zugriff auf globale Funktion
